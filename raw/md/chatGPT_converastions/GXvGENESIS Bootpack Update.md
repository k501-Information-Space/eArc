...
## system · 2026-01-26T21:29:44.812806 UTC



---

## user · 2026-01-26T21:29:52.301650 UTC

# GXvGENESIS · ARCHIVATOR — BOOTPACK v0.5
...
# - Here-doc must be closed EXACTLY with the token alone on a line: PY
...
: > "$GX_DB/frames.ndjson" 2>/dev/null || true
: > "$GX_DB/index.ndjson"  2>/dev/null || true
...
# BEHAVIOR:
# - If ts_unix missing: set best-effort host time.
# - Append the raw JSON line to frames.ndjson.
# - If GX_INDEX=1: append minimal pointer line to index.ndjson.
...
def emit_index(obj: Dict[str, Any]) -> None:
    if os.environ.get("GX_INDEX", "0") != "1":
        return
    # index.ndjson: minimal pointer (append-only)
    entry = {
        "id": obj.get("id"),
        "t": obj.get("t"),
...
#    Optional: also write minimal index pointers by setting GX_INDEX=1 for this command only.
...
## system · 2026-01-26T21:29:57.061391 UTC



---

## assistant · 2026-01-26T21:29:57.132281 UTC
...
## system · 2026-01-26T21:29:57.135239 UTC



---

## assistant · 2026-01-26T21:29:57.385906 UTC
